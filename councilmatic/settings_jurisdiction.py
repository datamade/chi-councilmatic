...
MANUAL_HEADSHOTS = {
    ...
    # 'thompson-patrick-d':   {'source': '', 'image': 'manual-headshots/thompson-patrick-d.jpg' },
    ...
    # 'curtis-derrick-g':     {'source': '', 'image': 'manual-headshots/curtis-derrick-g.jpg' },
    # 'dowell-pat':           {'source': '', 'image': 'manual-headshots/dowell-pat.jpg' },
    # 'emanuel-rahm':         {'source': '', 'image': 'manual-headshots/emanuel-rahm.jpg' },
    # 'ervin-jason-c':        {'source': '', 'image': 'manual-headshots/ervin-jason-c.jpg' },
    ...
    # 'hopkins-brian':        {'source': '', 'image': 'manual-headshots/hopkins-brian.jpg' },
    # 'laurino-margaret':     {'source': '', 'image': 'manual-headshots/laurino-margaret.jpg' },
    # 'lopez-raymond-a':      {'source': '', 'image': 'manual-headshots/lopez-raymond-a.jpg' },
    ...
    # 'moore-david-h':        {'source': '', 'image': 'manual-headshots/moore-david-h.jpg' },
    # 'oconnor-patrick':      {'source': '', 'image': 'manual-headshots/oconnor-patrick.jpg' },
    # 'pawar-ameya':          {'source': '', 'image': 'manual-headshots/pawar-ameya.jpg' },
    # 'quinn-marty':          {'source': '', 'image': 'manual-headshots/quinn-marty.jpg' },
    # 'reilly-brendan':       {'source': '', 'image': 'manual-headshots/reilly-brendan.jpg' },
    # 'santiago-milagros-s':  {'source': '', 'image': 'manual-headshots/santiago-milagros-s.jpg' },
    # 'scott-jr-michael':     {'source': '', 'image': 'manual-headshots/scott-jr-michael.jpg' },
    # 'smith-michele':        {'source': '', 'image': 'manual-headshots/smith-michele.jpg' },
    # 'sposato-nicholas':     {'source': '', 'image': 'manual-headshots/sposato-nicholas.jpg' },
}
